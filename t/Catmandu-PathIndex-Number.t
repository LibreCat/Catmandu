...
is_deeply(
    $p->get( 123456789 ),
    { _id => "123456789", _path => File::Spec->catdir( $dir, "123", "456", "789" ) },
    "get returns mapping"
);

is_deeply(
    $p->add( 1 ),
    { _id => "000000001", _path => File::Spec->catdir( $dir, "000", "000", "001" ) },
    "number are converted to left padded strings"
);

is_deeply(
    $p->add( "000000002" ),
    { _id => "000000002", _path => File::Spec->catdir( $dir, "000", "000", "002" ) },
