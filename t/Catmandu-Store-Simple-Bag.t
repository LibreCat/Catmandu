...
note("add");
{
    ...
    ok $bag->upload(IO::File->new('t/data2/000/000/002/test.txt'), 'test2.txt');

    ok -f 't/data/000/001/234/test2.txt' , 'test2.txt exists';

    ok $bag->upload(IO::File->new('t/data2/000/000/003/test.txt'), 'test3.txt');
...
note("list");
{
    ...
    is_deeply $array , [qw(test1.txt test2.txt test3.txt)] , 'got correct response';
}
