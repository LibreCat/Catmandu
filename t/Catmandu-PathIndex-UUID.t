...
is_deeply(
    $p->get( "11979D40-F504-11E7-AD0C-1F86AB14EC2F" ),
    {
        ...
        _path => File::Spec->catdir( $dir, "119","79D","40-","F50","4-1","1E7","-AD","0C-","1F8","6AB","14E","C2F" )
    },
    "get returns mapping"
);
...
is_deeply(
    ...
    [
        ...
        },
        {
            ...
            _path =>  File::Spec->catdir( $dir, "699","8EB","AE-","CEE","7-1","1E7","-97","D5-","911","D6E","E43","09A" )
        }
    ],
...
is_deeply(
    $p->to_array(),
    [],
    "list of entries should be empty now"
);

my $t2 = File::Temp->newdir( EXLOCK => 0, UNLINK => 1 );
my $dir2 = Cwd::abs_path( $t->dirname );

path( File::Spec->catdir( $dir2, qw(1 2 3 4 5 5 6 7 8 9 10 11 12 13) ) )->mkpath();
