...
Mailing list: L<librecat-dev@listservice.lub.lu.se> to
...
L<http://github.com/PerlDancer/Catmandu/issues>.
...
L<Dist::Zilla>. We also recommend perlbrew (see below) to test and develop Catmandu on a recent version of perl. We also
...
Fork the repository L<http://github.com/PerlDancer/Catmandu> (click "Fork")
...
L<librecat-dev@listservice.lub.lu.se>

=head2 Repositories

The official repository is hosted on GitHub at the following location:
L<git@github.com:LibreCat/Catmandu>
